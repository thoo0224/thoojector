...
void Injector::ShellCode(MANUAL_MAPPING_DATA* pData)
{
	if (!pData)
		return;
...
Injector::InjectResult Injector::InternalManualMap(HANDLE hProc, const char* szDllFile)
{
...
Injector::InjectResult Injector::ManualMap(HANDLE hProc, const char* szDllFile)
{
...
Injector::InjectResult Injector::InternalNativeInject(HANDLE hProc, const char* szDllFile)
{
...
Injector::InjectResult Injector::NativeInject(HANDLE hProc, const char* szDllFile, bool CloseHandleAfterInject)
{
...
HANDLE Injector::OpenProcessHandle(DWORD pId)
{
...
DWORD Injector::FindProcessId(const char* ProcessExeFile)
{
